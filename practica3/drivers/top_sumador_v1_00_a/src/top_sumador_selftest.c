/*****************************************************************************
* Filename:          N:\ws\practica3/drivers/top_sumador_v1_00_a/src/top_sumador_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the top_sumador driver
...
XStatus TOP_SUMADOR_SelfTest(void * baseaddr_p)
{
  ...
  TOP_SUMADOR_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = TOP_SUMADOR_mReadSlaveReg0(baseaddr, 0);
  ...
  TOP_SUMADOR_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = TOP_SUMADOR_mReadSlaveReg1(baseaddr, 0);
  ...
  TOP_SUMADOR_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = TOP_SUMADOR_mReadSlaveReg2(baseaddr, 0);
  ...
  TOP_SUMADOR_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = TOP_SUMADOR_mReadSlaveReg3(baseaddr, 0);
