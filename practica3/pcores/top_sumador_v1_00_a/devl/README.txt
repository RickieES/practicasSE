...
Peripheral Summary:
  ...
  XPS project / EDK repository               : N:\ws\practica3
  logical library name                       : top_sumador_v1_00_a
  top name                                   : top_sumador
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
- XST synthesis file(s)
  ...
  devl/synthesis/top_sumador_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/top_sumador_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/top_sumador_v2_1_0.tcl
...
plbv46_slave_single_v1_01_a
	N:\ws\practica3\C:\Xilinx\14.1\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\plbv46_slave_single_v1_01_a\doc\plbv46_slave_single.pdf
