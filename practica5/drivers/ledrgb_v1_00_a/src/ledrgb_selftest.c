/*****************************************************************************
* Filename:          C:\hlocal\XilinxProyectos\Practica5/drivers/ledrgb_v1_00_a/src/ledrgb_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the ledrgb driver
...
XStatus LEDRGB_SelfTest(void * baseaddr_p)
{
  ...
  LEDRGB_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = LEDRGB_mReadSlaveReg0(baseaddr, 0);
  ...
  LEDRGB_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = LEDRGB_mReadSlaveReg1(baseaddr, 0);
  ...
  LEDRGB_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = LEDRGB_mReadSlaveReg2(baseaddr, 0);
