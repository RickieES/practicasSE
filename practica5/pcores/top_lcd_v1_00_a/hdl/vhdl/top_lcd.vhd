------------------------------------------------------------------------------
-- top_lcd.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          top_lcd.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Tue Dec 06 20:59:07 2022 (by Create and Import Peripheral Wizard)
...
use top_lcd_v1_00_a.user_logic;
...
architecture IMP of top_lcd is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity top_lcd_v1_00_a.user_logic
    generic map
    (
