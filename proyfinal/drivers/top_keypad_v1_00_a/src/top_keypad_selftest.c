/*****************************************************************************
* Filename:          N:\ws\practica5/drivers/top_keypad_v1_00_a/src/top_keypad_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the top_keypad driver
...
XStatus TOP_KEYPAD_SelfTest(void * baseaddr_p)
{
  ...
  TOP_KEYPAD_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = TOP_KEYPAD_mReadSlaveReg0(baseaddr, 0);
