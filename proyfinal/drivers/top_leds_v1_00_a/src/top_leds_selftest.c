/*****************************************************************************
* Filename:          N:\ws\proyfinal/drivers/top_leds_v1_00_a/src/top_leds_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the top_leds driver
...
XStatus TOP_LEDS_SelfTest(void * baseaddr_p)
{
  ...
  TOP_LEDS_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = TOP_LEDS_mReadSlaveReg0(baseaddr, 0);
  ...
  TOP_LEDS_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = TOP_LEDS_mReadSlaveReg1(baseaddr, 0);
  ...
  TOP_LEDS_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = TOP_LEDS_mReadSlaveReg2(baseaddr, 0);
