/*****************************************************************************
* Filename:          N:\ws\proyfinal/drivers/top_motor_v1_00_a/src/top_motor_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the top_motor driver
...
XStatus TOP_MOTOR_SelfTest(void * baseaddr_p)
{
  ...
  TOP_MOTOR_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = TOP_MOTOR_mReadSlaveReg0(baseaddr, 0);
  ...
  TOP_MOTOR_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = TOP_MOTOR_mReadSlaveReg1(baseaddr, 0);
