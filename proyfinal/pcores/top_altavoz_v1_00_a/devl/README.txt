...
Peripheral Summary:
  ...
  logical library name                       : top_altavoz_v1_00_a
  top name                                   : top_altavoz
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
- XST synthesis file(s)
  ...
  devl/synthesis/top_altavoz_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/top_altavoz_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/top_altavoz_v2_1_0.tcl
